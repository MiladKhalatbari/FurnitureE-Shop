...
public class CreateCartCommandHandlerTest : IRequestHandler<CreateCartCommand, int>
{
    private readonly IMapper _mapper;
    private readonly ICartRepository _cartRepository;

    public CreateCartCommandHandlerTest(IMapper mapper, ICartRepository cartRepository)
    {
        _mapper = mapper;
